...
await delay(5 * 5000)
await conn.sendMessage(res, { text: text + ( users == 593993684821 ? '\n\n_atte. 𝙏𝙃𝙀-𝙏𝙀𝘼𝙈-𝙂𝘼𝙏𝙊 𝘽𝙊𝙏_' : '' || users == 593968585383 ? '\n\n_atte. 𝙏𝙃𝙀-𝙏𝙀𝘼𝙈-𝙂𝘼𝙏𝙊 𝘽𝙊𝙏_' : '' || users ==59894808483 ? '\n\n_atte. 𝙏𝙃𝙀-𝙏𝙀𝘼𝙈-𝙂𝘼𝙏𝙊 𝘽𝙊𝙏_' : '' || users ==5492266466080 ? '\n\n_atte. 𝙏𝙃𝙀-𝙏𝙀𝘼𝙈-𝙂𝘼𝙏𝙊 𝘽𝙊𝙏_' : '' || users == 5492266613038 ? '\n\n_atte. 𝙏𝙃𝙀-𝙏𝙀𝘼𝙈-𝙂𝘼𝙏𝙊 𝘽𝙊𝙏_' : '' ), mentions: (await conn.groupMetadata(`${res}`)).participants.map(v => v.id) }, { quoted: fkontak })
