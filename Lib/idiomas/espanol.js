...
const smsVersion = () => { return `𝙑𝙚𝙧𝙨𝙞𝙤𝙣 𝙙𝙚𝙡 𝙏𝙃𝙀-𝙏𝙀𝘼𝙈 -𝙂𝘼𝙏𝙊 𝘽𝙊𝙏`}
...
//_allantilink.js
const smsTextoYT = () => { return '🤩 𝙎𝙪𝙥𝙚𝙧 𝚃𝙷𝙴 𝙶𝙰𝚃𝙾 𝙱𝙻𝙰𝙺 𝙱𝙾𝚃 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
//_antispam.js
const smsNoSpam = () => { return ' 𝙏𝙃𝙀 𝙂𝘼𝙏𝙊 𝘽𝙇𝘼𝙆 𝘽𝙊𝙏 \n🤨 No hagas spam, no podra usar a el bot Por 5 Minuto'}

//_antispam_.js
const smsNoSpam2 = () => { return `𝙏𝙃𝙀-𝙏𝙀𝘼𝙈-𝙂𝘼𝙏𝙊 𝘽𝙊𝙏 \nFue desbaneado después de 5 Minuto. por favor no haga spam!!`}
...
const eGataCoins = () => { return '🐱 catCoins' }
const eGataTickers = () => { return '🎫 cat Tickers' } 
...
//_autosticker.js
const smsAutoStik = () => { return `${lenguajeGB['smsAvisoFG']()}*𝙏𝙃𝙀-𝙏𝙀𝘼𝙈-𝙂𝘼𝙏𝙊 𝘽𝙊𝙏 \nEL VÍDEO NO DEBE DE DURAR MÁS DE 7 SEGUNDOS.*`} 
...
const smsContacto4 = () => { return 'Contacto Oficial de 𝑩𝑳𝑨𝑲𝒁𝑰𝑵ت︎'}
